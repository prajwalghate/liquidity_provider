...
let usdcAddress = "0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C" //goerli
...
async function main() {
    ...
    console.log("lpstake address:", lpstake.address)
    const usdcToken = new ethers.Contract(usdcAddress, minABI, owner)
    console.log(usdcToken.address, "usdtoken contract")
    const transactionResponse = await usdcToken.approve(
        lpstake.address,
        1000000
    )
